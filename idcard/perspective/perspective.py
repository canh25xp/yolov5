...
def main(args):
    ...
    maskPath = ROOT/"output/camera/mask/IMG_4329_0_cccdc_back.jpg" #+ inputPath.name
            
    img = cv.imread(str(inputPath))
    mask = cv.imread(str(maskPath), cv.COLOR_BGR2GRAY)
    out = img.copy()
...
if(__name__ == '__main__'):
    ...
    parser.add_argument('--source', default= ROOT/'input/camera/IMG_4329.JPG', help='input path')
